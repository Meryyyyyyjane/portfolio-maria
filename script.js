...
const i18n = {
  es: {
    ...
    "projects.p1.b2": "Fortalezas: coherencia total del customer journey, savoir-faire artesanal transmitido por el equipo, ausencia de presión comercial. Áreas de mejora: discreción excesiva inicial, integración de elementos digitales, percepción de surtido limitado.",
    "projects.p1.b3": "Propuesta de evolución del uniforme: negro elegante con detalle naranja Hermès y pañuelo de seda como guiño al heritage.",
  ...
  en: {
    ...
    "projects.p1.b2": "Strengths: full coherence of the customer journey, savoir-faire transmitted by the team, absence of commercial pressure. Areas to improve: excessive initial discretion, integration of digital elements, perception of limited assortment.",
    "projects.p1.b3": "Uniform evolution proposal: elegant black with Hermès orange detailing and a silk scarf as a heritage nod.",
