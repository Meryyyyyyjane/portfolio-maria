...
const i18n = {
  ...
  en: {
    ...
    "manifesto.p1": "Luxury retail is moving away from positioning itself as a place where products are purchased, into a place where experiences are lived. In 2026, the physical store is becoming an immersive destination — every touchpoint working to create a deeper connection with the customer, weaving hospitality and entertainment into the commercial space itself.",
    "manifesto.p2": "This transformation coexists with a more demanding market context. The luxury industry is entering a phase of stabilisation and selectivity, where growth depends less on volume and more on perceived value and cultural relevance of the brand. That's why the in-person experience — personalised appointments, private showrooms, pop-ups — has become a real differentiator versus more accessible brands, not an optional add-on. From the store side, this translates into a very concrete responsibility: every brand standard we execute daily — from the window display to the way a customer is treated in the fitting room — is, in fact, a piece of the company's global strategy, even if it sometimes feels like just another operational task.",
    "manifesto.p3": "I also believe technology and data will keep gaining weight, but not as a substitute for people — as their support. Tools like augmented reality or personalised video-shopping already allow us to deliver high-attention service inside a digital environment, and this only works if there are store teams behind capable of interpreting that data and translating it into real on-the-ground decisions. My experience coordinating sales, conversion and average ticket KPIs day-to-day has given me that hybrid view: I can read a data point, but I also know what it means in terms of real customer behaviour.",
    "manifesto.p4": "That's why I understand luxury retail not as two separate worlds — the headquarters that designs the strategy and the store that executes it — but as one same ecosystem. The challenge of the coming years isn't only to create memorable experiences, but to make sure that brand vision arrives intact at the last touchpoint with the customer. And that is, precisely, the space in which I want to keep growing: <strong>in the bridge between the experience strategy designed at headquarters and the reality lived every day on the shop floor.</strong>",
