...
const i18n = {
  es: {
    ...
    "manifesto.p1": "Llevo tres años en tienda. Primero en Nícoli, después en Scalpers, donde hoy soy Store Manager en el corner de ECI Diagonal y gestiono tres departamentos en paralelo. En todo este tiempo he aprendido algo simple: <strong>la tienda es donde la marca se gana o se pierde</strong>. Ningún guideline de central sobrevive si quien lo ejecuta no lo entiende — y ningún equipo ejecuta bien si no sabe por qué hace lo que hace.",
    "manifesto.p2": "Mi objetivo es dar el salto a HQ, a un rol de conceptualización y estrategia de retail. Y lo hago desde la otra orilla: sé qué guidelines funcionan en tienda y cuáles fallan al chocar con el día a día, qué cambios de colección rentan y cuáles solo generan ruido, qué hace que una tienda con bajo rendimiento recupere ventas — lo viví reasignada a la tienda TTGG de Scalpers, con un +50% de facturación semanal tras rediseñar visual merchandising y rotación. Esa lectura es la que quiero llevar al diseño de la estrategia, no solo a su ejecución.",
    "manifesto.p3": "Trabajo siempre con dos vistas: la del cliente y la del Excel. Vengo de una formación visual (IDEM, IED) y de un Máster en Fashion & Retail Management (EAE) que me ha dado el lenguaje del negocio. Mis referencias son marcas que tratan el retail físico como la prueba más exigente de la coherencia de marca — <em>Hermès, LOEWE, Toteme, Bottega Veneta, Loro Piana</em> — todas muy distintas, todas con algo en común: la tienda como primer punto de contacto con la marca, no como el último.",
  ...
  en: {
    ...
    "manifesto.p1": "I've spent three years on the shop floor. First at Nícoli, then at Scalpers, where I'm now Store Manager at the ECI Diagonal corner, running three departments in parallel. In that time I've learned one simple thing: <strong>the store is where a brand is won or lost</strong>. No HQ guideline survives if the person executing it doesn't understand it — and no team executes well if it doesn't know why it's doing what it's doing.",
    "manifesto.p2": "My goal is to move into HQ, into a retail strategy and concept role. And I bring the view from the other side: I know which guidelines work on the floor and which break in daily reality, which collection rotations pay off and which just generate noise, what it takes to turn around an underperforming store — I lived it, reassigned to Scalpers' TTGG store, with a +50% weekly revenue uplift after redesigning visual merchandising and product rotation. That reading is what I want to bring to strategy design, not just execution.",
    "manifesto.p3": "I always work with two views: the customer's and the Excel sheet's. I come from a visual background (IDEM, IED) and a Master in Fashion & Retail Management (EAE) that gave me the language of the business. My references are brands that treat physical retail as the most demanding test of brand coherence — <em>Hermès, LOEWE, Toteme, Bottega Veneta, Loro Piana</em> — all very different, all with one thing in common: the store as the first point of contact with the brand, never the last.",
